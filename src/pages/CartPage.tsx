...
export const CartPage = () => {
  ...
  const handleCheckout = () => {
    ...
    placeOrder({
      ...
      items: items.map((i) => ({
        menuItemId: i.id, // Guid as string — matches OrderItemDto
        quantity: i.quantity,
      })),
    });
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center animate-fade-up">
          ...
          <h2 className="text-2xl font-bold font-display text-stone-800 mb-2">
            Your cart is empty
          </h2>
          ...
          <div className="bg-white rounded-2xl border border-stone-100 p-6 h-fit shadow-sm">
            ...
            <div className="mb-5">
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl border border-stone-200 focus:outline-none focus:ring-2 focus:ring-brand-400 text-sm resize-none text-stone-800 placeholder-stone-300"
              />
            </div>
            <Button
              size="lg"
